...
final Map<int, List<Message>> mockMessages = {
  ...
  4: [
    Message(id: 1, text: 'I can\'t breathe', sent: false),
  ],
  5: [
    Message(id: 1, text: 'Hey Kirk, are you coming to the Pizza Party tonight?', sent: true),
    Message(id: 2, text: 'Absolutely!', sent: false),
    Message(id: 3, text: 'See you at the Pizza Party tonight!', sent: false),
  ],
  6: [
    Message(id: 1, text: 'haa use use use use wa', sent: false),
  ],
};